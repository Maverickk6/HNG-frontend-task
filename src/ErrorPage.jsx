...
export default function ErrorPage() {
  ...
  return (
    <div className="h-full w-full flex flex-col px-20 pt-20 pb-4 justify-center">
      <div
        id="error_page"
        className="w-[45vW] h-[50vH] rounded-md p-4 mb-12"
      >
        <p className="text-xs text-blue-500 mb-4">404 error</p>
        <h1 className="text-[50px] leading-8 mb-10 mt-8">We can't find that page</h1>
        <p className="mb-10 font-light text-[16px]">Sorry, the page you are looking for doesn't exist.</p>
